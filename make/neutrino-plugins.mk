...
$(ARCHIVE)/links-$(LINKS-VER).tar.bz2:
	$(WGET) https://links.twibright.com/download/links-$(LINKS-VER).tar.bz2
...
$(D)/neutrino-mp-plugins.do_prepare:
	...
	set -e; if [ -d $(ARCHIVE)/neutrino-mp-plugins.git ]; \
		...
		else cd $(ARCHIVE); git clone https://github.com/Duckbox-Developers/neutrino-mp-plugins.git neutrino-mp-plugins.git; \		fi
